...
import { appConfig, contractPreSaleBSC } from "@/app/configs";
...
import { ETH, logo_svg, money } from "../../assets/images";
...
interface StableBNBFormProps {}

const StableBNBForm: React.FC = (props: StableBNBFormProps) => {
